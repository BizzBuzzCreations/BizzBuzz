...
//
// Typing a literal `<a href="...">text</a>` straight into the editor is
// handled at the source instead of here — see
// components/ui/typedLinkInputRule.js, wired into both rich text editors
// — so it becomes a real link mark the moment it's typed, rather than
// ever being saved as escaped tag text that this function would need to
// unpick (which turned out unreliable: Tiptap's own autolink can convert
// just the URL substring inside the typed href as you type, before this
// ever sees the saved HTML, leaving a half-converted mess no render-time
// regex can cleanly undo).
