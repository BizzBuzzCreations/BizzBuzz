...
export default function ServicesHero({ heading, description, img }) {
  return (
    <div
      ...
      className="min-h-screen md:pt-50 pt-30 lg:text-left text-center text-white gap-10 flex 2xl:px-15 px-10 lg:flex-row flex-col justify-center items-center pb-30 mb-10"
    >
      <div>
