    ...
    <>
        <div className="mb-20 max-w-6xl mx-auto container">
          ...
          <div className="flex flex-wrap gap-5 items-center justify-center overflow-hidden">
            <div className="group relative max-w-lg overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 transition-all duration-300 hover:shadow-xl hover:scale-105 cursor-pointer">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    ...
                    quantum computing solution.Experience the future of
                    technology with our revolutionary quantum computing
                    solution.
                  </p>
                  {/* Button */}
                  <div className="mt-6">
